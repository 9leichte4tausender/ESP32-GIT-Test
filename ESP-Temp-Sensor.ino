...
//
//  10.02.2019  SR  Korrektur auf DHT22
//
#include <DHTesp.h>
DHTesp dht;
const int dhtPin = 17;
...
//  String temp = String(dht.getTempAndHumidity());
  ...
  if (dht.getStatus() != 0) {
    ...
    Serial.println("Feuchte: " + humidity);
  }
...
void setup() {
  // 10.02.2019 SR Hier muss DHT22 stehen, sonst wird nur 0 zurückgeliefert
